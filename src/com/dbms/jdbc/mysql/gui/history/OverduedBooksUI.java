...
public class OverduedBooksUI extends javax.swing.JFrame {

    /**
     * Creates new form OverduedBooksUI
     */
    private OverduedBooksDAO overDAO;
    private IssuedBooksUI issuedUI;
    private int userLevel;
    private String userName;
    public OverduedBooksUI(int level,String name,IssuedBooksUI ui) {
        try{
            overDAO = new OverduedBooksDAO();
        }
        catch(Exception exc){
            JOptionPane.showMessageDialog(OverduedBooksUI.this,"DAO Failed: "+exc.getMessage(),"DAO Error",JOptionPane.ERROR_MESSAGE);
        }
        initComponents();
    ...
    private void initComponents() {
        ...
        jtbl_Overdued = new javax.swing.JTable();
        ...
        jtbl_Overdued.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(jtbl_Overdued);
    ...
    private void jtxt_SearchKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtxt_SearchKeyTyped
        ...
        try{
            ...
            JOptionPane.showMessageDialog(OverduedBooksUI.this,"Search Failed: "+exc.getMessage(),"Search Error",JOptionPane.ERROR_MESSAGE);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OverduedBooksUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OverduedBooksUI().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable jtbl_Overdued;
    ...
    private void populateTable(){
        try{
            ...
            JOptionPane.showMessageDialog(OverduedBooksUI.this,"Load Failed: "+exc.getMessage(),"Load Error",JOptionPane.ERROR_MESSAGE);
        }
    }
}
