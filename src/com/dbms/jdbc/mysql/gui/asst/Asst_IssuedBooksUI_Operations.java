...
public class Asst_IssuedBooksUI_Operations extends javax.swing.JDialog {

    /**
     * Creates new form Asst_IssuedBooksUI_Operations
     */
    ...
    public Asst_IssuedBooksUI_Operations(String oprtn,int level,String userID,IssuedBooks issued,
            IssuedBooksDAO dao,Asst_IssuedBooksUI ui){
        try{
            accDAO = new AccountsDAO();
            bookDAO = new BooksDAO();
        }
        catch(Exception exc){
            JOptionPane.showMessageDialog(Asst_IssuedBooksUI_Operations.this,"DAO Failed: "+exc.getMessage(),"DAO Error",JOptionPane.ERROR_MESSAGE);
        }
        initComponents();
    ...
    public Asst_IssuedBooksUI_Operations(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jLabel5))
                .addGap(26, 26, 26)
                .addComponent(jbtn_Submit, javax.swing.GroupLayout.DEFAULT_SIZE, 43, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Asst_IssuedBooksUI_Operations.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Asst_IssuedBooksUI_Operations dialog = new Asst_IssuedBooksUI_Operations(new javax.swing.JFrame(), true);
    ...
    private void returnBook(){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(Asst_IssuedBooksUI_Operations.this,"Return Failed: "+exc.getMessage(),"Return Error",JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void renewBook(){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(Asst_IssuedBooksUI_Operations.this,"Renewal Failed: "+exc.getMessage(),"Renewal Error",JOptionPane.ERROR_MESSAGE);
        }
