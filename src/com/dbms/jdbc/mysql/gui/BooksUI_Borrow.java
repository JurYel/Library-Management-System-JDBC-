...
import com.dbms.jdbc.mysql.gui.student.Student_BooksUI;
import java.util.Iterator;
import javax.swing.JOptionPane;

public class BooksUI_Borrow extends javax.swing.JDialog {

    /**
     * Creates new form BooksUI_Borrow
     */
    ...
    private Student_BooksUI studBookUI;
    private String User_ID;
    private String User_Name;
    private int userLevel;
    
    public BooksUI_Borrow(int level,String userID, String name, Books theBook,
                BooksDAO theDAO,BooksUI ui,Student_BooksUI studUI){
        try{
            accDAO = new AccountsDAO();
            issuedDAO = new IssuedBooksDAO();
        }
        catch(Exception exc){
            JOptionPane.showMessageDialog(BooksUI_Borrow.this,"DAO Failed: "+exc.getMessage(),"DAO Error",JOptionPane.ERROR_MESSAGE);
        }
        initComponents();
    ...
    public BooksUI_Borrow(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BooksUI_Borrow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BooksUI_Borrow dialog = new BooksUI_Borrow(new javax.swing.JFrame(), true);
    ...
    private void borrowBook(int userLvl){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(BooksUI_Borrow.this,"Issue Failed: "+exc.getMessage(),"Issue Error",JOptionPane.ERROR_MESSAGE);
//            exc.printStackTrace();
        }
    }
    private void retrieveIssuedBook(){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(BooksUI_Borrow.this,"Retrieval Failed: "+exc.getMessage(),"Retrieval Error",JOptionPane.ERROR_MESSAGE);
//            exc.printStackTrace();
        }
    }
    ...
    private void populateGUI(Books book){
        try{
            ...
            JOptionPane.showMessageDialog(BooksUI_Borrow.this,"Load Failed: "+exc.getMessage(),"Load Error",JOptionPane.ERROR_MESSAGE);
        }
    }
